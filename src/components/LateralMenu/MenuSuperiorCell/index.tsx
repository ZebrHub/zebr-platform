...
import imgLogo from '../../../assets/image/Identidade.png';
import { useNavigate } from 'react-router-dom';
import './style.scss'

export function MenuSuperiorCell() {
    ...
    const [isMenuBarOpen, setIsMenuBarOpan] = useState(false);

    function menuBarClick() {
        setIsMenuBarOpan(!isMenuBarOpen);
    }

    return (
        <>
            <div className='menuSuperiorCell-container'>
                <div className='menuSuperiorCell-content' onClick={menuBarClick}>
                    <svg style={{ display: isMenuBarOpen ? 'none' : 'block' }}
                    ...
                    <svg style={{ display: isMenuBarOpen ? 'block' : 'none' }}
                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
            ...
            <div className='logo-suspensa-home'>
                <img src={imgLogo} alt="logo-zebr" />
            </div>


            {/* ------------------------------------------------------------------------------- */}
            <div className='menuInferiorCell-container' style={{ opacity: isMenuBarOpen ? 1 : 0 }}>
                <div className='menuInferiorCell-content'>
