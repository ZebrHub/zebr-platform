    ...
    return (
        <div className='lateralMenu-container'>
            ...
            <div className='lateralMenu-content'>
                ...
                <div className='itens' onClick={handleProject}>
                ...
                <div className='itens' onClick={handleTraining}>
                ...
                <div className='itens' onClick={handleFaq}>
